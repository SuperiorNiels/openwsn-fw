...
void whisper_init() {
    ...
    whisper_vars.timerPeriod = 5000; // FIXME: maybe 5 seconds?
...
void whisperClearStateCb(opentimers_id_t id) {
    ...
    whisper_vars.whisper_sixtop.waiting_for_response = FALSE;
    // Clear all packets generated by whisper
    whisperClearGeneratedPackets();
}
...
void whisperClearGeneratedPackets() {
